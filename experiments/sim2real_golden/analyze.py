...
def main():
    ...
    # Table 1: Adaptive-expanded vs Baseline
    if "adaptive-expanded" in all_policies:
    ...
    # Table 4: Expanded vs v2
    if "adaptive-expanded" in all_policies and "adaptive-v2" in all_policies:
        print_comparison(data, "adaptive-v2", "adaptive-expanded",
                         "Adaptive-expanded vs Adaptive-v2 (does 5-scorer help?)")

    # Table 5: Expanded vs Glia
    if "adaptive-expanded" in all_policies and "glia" in all_policies:
        print_comparison(data, "glia", "adaptive-expanded",
                         "Adaptive-expanded vs Glia HRA")

    # Table 6: v2 vs Glia
    if "adaptive-v2" in all_policies and "glia" in all_policies:
