#!/usr/bin/env bash
# Golden Adaptive Router Benchmark
#
# Runs 3 policies across 7 workloads, 3 seeds each.
# Total: 3 x 7 x 3 = 63 runs.
#
# Usage:
#   cd experiments/strategy_evolution_golden/bundle
#   bash run.sh
...
echo "============================================================"
echo " Golden Adaptive Router Benchmark"
echo "============================================================"
echo ""
echo "Model:       $MODEL"
...
for wl_entry in $WORKLOADS; do
    ...
    for pol_entry in $POLICIES; do
        ...
        for seed in $SEEDS; do
            ...
            printf "  %-15s %-18s seed=%-3s ... " "$wl_name" "$policy_name" "$seed"
